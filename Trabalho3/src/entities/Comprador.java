...
public class Comprador extends Pessoa {
	...
	public static void comprarProduto() {
		...
		while (continuarComprando) {
			...
			File estoqueFile = new File("C:\\Users\\vanes\\git\\Trabalho-Compras-JSON\\3. TRABALHO POO - COMPRAS\\estoque.json");
		...
		for(Compra c : compras) {
			...
			compraJSON.put("id:", c.getIdCompra());
		...
		try(FileWriter writer = new FileWriter("C:\\Users\\vanes\\git\\Trabalho-Compras-JSON\\3. TRABALHO POO - COMPRAS\\historico_de_compras.json", true)){
